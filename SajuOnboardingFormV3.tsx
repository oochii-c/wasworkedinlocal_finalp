...
/**
 * AI 사주 온보딩 폼 (한지 · 인장 버전) - React (TypeScript)
...
export default function SajuOnboardingFormV3(): React.JSX.Element {
  ...
  const [loadingTextVisible, setLoadingTextVisible] = useState<boolean>(true);
  ...
  function handleUnknownTimeChange(checked: boolean): void {
