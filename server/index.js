...
규칙:
1. 반드시 3~4문장으로 작성. 이 해의 기운/실천 방향/구체적 조언을 각각 다른 문장에 담아.
2. ${zodiac}의 해 특성을 자연스럽게 한 문장에 녹여.
3. 일간 ${dayGan}(${dayElem}) 기준으로 구체적으로, 따뜻하게.
4. 이사·이직처럼 환경을 바꾸기에 이 해가 어떤지도 한 문장에 넌지시 담아라. 단, "상반기"·"하반기"·"환절기 무렵"처럼 두루뭉실하게만 표현하고, 특정 월·일 같은 구체적 날짜는 절대 언급하지 마라.
