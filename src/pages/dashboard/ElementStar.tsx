...
import { WUXING_SVG_COLOR, strengthLabel, strengthParticle, GRAPH_FULL_SHARE } from "./constants";
...
const ELEMENT_DESC: Record<string, Record<string, string>> = {
  木: {
    풍부한: "木은 위로 곧게 뻗어 오르는 성장과 생명력의 기운이에요. 새로운 시작과 추진력을 상징하죠. 당신의 사주에는 이 기운이 풍부해, 도전을 두려워하지 않고 먼저 나서는 힘이 강해요. 다만 그만큼 고집이 셀 수 있으니, 주변을 살피는 유연함도 함께 키워보세요.",
    ...
    "채워야 하는": "木은 위로 곧게 뻗어 오르는 성장과 생명력의 기운이에요. 새로운 시작과 추진력을 상징하죠. 당신의 사주에는 이 기운이 거의 없어, 혼자 앞서기보다 함께 가는 협력의 방식이 훨씬 자연스럽게 맞아요.",
  },
  火: {
    풍부한: "火는 사방으로 빛을 뿜어내는 열정과 표현의 기운이에요. 따뜻함과 사교성을 상징하죠. 당신의 사주에는 이 기운이 넘쳐, 어디서든 존재감이 뚜렷하고 사람들을 끌어당기는 매력이 있어요. 다만 감정의 기복이 클 수 있으니, 내면을 가라앉히는 시간을 의식적으로 가져보세요.",
    ...
    "채워야 하는": "火는 사방으로 빛을 뿜어내는 열정과 표현의 기운이에요. 따뜻함과 사교성을 상징하죠. 당신의 사주에는 이 기운이 거의 없어, 감정에 흔들리지 않는 차분하고 냉철한 판단력이 돋보여요. 그 이성적인 면이 오히려 큰 강점이에요.",
  },
  土: {
    풍부한: "土는 만물을 품고 중심을 잡아주는 안정과 포용의 기운이에요. 신뢰와 현실적인 감각을 상징하죠. 당신의 사주에는 이 기운이 풍부해, 어떤 상황에서도 흔들리지 않는 무게감과 포용력이 있어요. 다만 변화에 다소 느릴 수 있으니, 새로운 흐름을 받아들이는 유연함도 키워보세요.",
    ...
    "채워야 하는": "土는 만물을 품고 중심을 잡아주는 안정과 포용의 기운이에요. 신뢰와 현실적인 감각을 상징하죠. 당신의 사주에는 이 기운이 거의 없어, 정해진 틀에 얽매이지 않고 자유롭게 흐르는 에너지가 강해요. 다양한 경험을 통해 성장하는 타입이에요.",
  },
  金: {
    풍부한: "金은 불필요한 것을 걷어내고 본질만 남기는 결단과 정제의 기운이에요. 의리와 강직함을 상징하죠. 당신의 사주에는 이 기운이 넘쳐, 흑과 백을 명확히 가르는 결단력과 원칙에 대한 강한 신념이 있어요. 다만 지나친 고집은 관계를 어렵게 할 수 있으니, 조화를 찾는 연습도 필요해요.",
    ...
    "채워야 하는": "金은 불필요한 것을 걷어내고 본질만 남기는 결단과 정제의 기운이에요. 의리와 강직함을 상징하죠. 당신의 사주에는 이 기운이 거의 없어, 차갑고 단호한 면보다 따뜻하고 유연한 방식으로 사람들과 관계를 맺는 게 자연스러워요.",
  },
  水: {
    풍부한: "水는 깊은 곳에서 흘러나오는 지혜와 통찰의 기운이에요. 유연함과 직관을 상징하죠. 당신의 사주에는 이 기운이 넘쳐, 상황을 꿰뚫어 보는 직관과 어떤 환경에도 스며드는 적응력이 있어요. 다만 너무 흘러가기만 하면 방향을 잃을 수 있으니, 자신만의 중심을 세우는 게 중요해요.",
    ...
    "채워야 하는": "水는 깊은 곳에서 흘러나오는 지혜와 통찰의 기운이에요. 유연함과 직관을 상징하죠. 당신의 사주에는 이 기운이 거의 없어, 막연한 직관보다 경험과 논리를 바탕으로 판단하는 현실적인 성향이 강해요.",
  },
};
      ...
      {activeEl && (() => {
        ...
        return (
          <p className="db-ai-box">
            <b>
              <span style={{ color: WUXING_SVG_COLOR[activeEl] }}>{activeEl}</span> 기운{strengthParticle(strength)} {strength} 사주예요.
            </b>
